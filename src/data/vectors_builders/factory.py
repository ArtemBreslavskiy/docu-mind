...
from configs.schemas.pipeline.vector.builder import BaseVectorsBuilderConfig
...
def create_vectors_builder(config: BaseVectorsBuilderConfig, logger: logging.Logger) -> BaseVectorsBuilder | None:
    if config.type == "disabled":
        ...
        from data.vectors_builders.implementations.default_vectors_builder import DefaultVectorsBuilder
