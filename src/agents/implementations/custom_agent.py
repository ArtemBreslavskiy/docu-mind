...
from agents.tools.tool_factory import create_tools
from agents.json_parse_tool_calls import parse_tool_calls_from_text
...
class CustomAgent(BaseAgent):
    def __init__(
        ...
        self.logger = logger if logger is not None else get_logger("agents")
        if logger is None:
